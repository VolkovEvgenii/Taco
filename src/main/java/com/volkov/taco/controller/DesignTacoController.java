package com.volkov.taco.controller;


import com.volkov.taco.entity.Ingredient;
import com.volkov.taco.entity.Ingredient.Type;
...
public class DesignTacoController {
    ...
    public String showDesignForm(Model model) {
        ...
        List<Ingredient> ingredients = Arrays.asList(
                ...
                new Ingredient("SRCR", "Cour Cream", Ingredient.Type.SAUSE)
        );
